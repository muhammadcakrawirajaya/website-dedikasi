<?php
//Query Menampilkan Artikel Utama
...
//Query Menampilkan 6 Artikel
$query = "SELECT * FROM posts WHERE is_featured=0 ORDER BY date_time DESC LIMIT 3";
...
<div class="latest_article">
    <div class="title-container">
        <p>Blog</p>
        <h1 class="subtitle">Terbitan</h1>
        <h1 class="title">Artikel Terkini</h1>
        ...
        <section class="featured">
            <div class="container featured__container">
                ...
                <div class="post__info">
                    ...
                    ?>
                    <a href="category-posts.php?id=<?= $category_id ?>"
                    ...
                    <div class="featured-post-author">
                        ...
                        <div class="post__author-info">
                            <h5>Oleh: <?= "{$author['firstname']} {$author['lastname']}" ?></h5>
                            <small>
                ...
                <article class="post">
                    ...
                    <div class="post__info">
                        ...
                        <h2 class="post__title">
                            <a href="<?= ROOT_URL ?>post.php?id=<?= $post['id'] ?>"><?= substr($post['title'], 0, 20) ?>...
                            </a>
                        </h2>
                        ...
                        <div class="post__author">
                            ...
                            <div class="post__author-info">
                                <h5>Oleh: <?= "{$author_firstname} {$author_lastname}" ?></h5>
