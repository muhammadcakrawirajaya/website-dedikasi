...
<div class="title-container">
        <p>Galeri</p>
        <h1 class="subtitle">Selayang Pandang</h1>
        <h1 class="title">Pengabdian</h1>
            ...
            <figure>
                <div>
                    <div>
                        <h2>Catatan!</h2>
                        <p>Cek IG kami</p>
                        <p><br><small>klik link di bawah : <br><a target="_blank" href="https://codepen.io/wakana-k/pen/oNJxbPw">IG-nya DEDIKASi</a></small></p>
                    </div>
                </div>
            </figure>
            <figure>
